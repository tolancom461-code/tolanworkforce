...
- [ ] تحديث صفحة المستخدمين: إضافة حقل رقم الهاتف
- [ ] تحديث صفحة المستخدمين: إضافة قائمة منسدلة لاختيار الدور
- [ ] تحديث صفحة المستخدمين: عرض اسم الدور في الجدول
- [ ] تحديث صفحة المستخدمين: إمكانية التصفية حسب الدور
- [ ] تحديث صفحة صلاحيات المستخدمين: عرض جميع المستخدمين في قائمة
- [ ] تحديث صفحة صلاحيات المستخدمين: زر تعديل الصلاحيات لكل مستخدم
- [ ] تحديث صفحة صلاحيات المستخدمين: واجهة شاملة للصلاحيات الذرية
- [ ] تحديث صفحة صلاحيات المستخدمين: ترتيب الصلاحيات حسب الشاشات
- [ ] تحديث صفحة صلاحيات المستخدمين: نطاق محدد لكل صلاحية
