...
export default function OperationalFlagsSimplified() {
  const { user } = useAuth();
  ...
  const { data: pendingFlags, refetch: refetchPending } = trpc.operationalFlags.getPending.useQuery();
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pending Flags */}
      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4">البلاغات المعلقة</h2>
